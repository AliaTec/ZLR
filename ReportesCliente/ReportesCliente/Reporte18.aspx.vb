...
Partial Public Class Reporte18

    Inherits System.Web.UI.Page

    Public RPT As New ISNGUA
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomISNGUA @IdRazonSocial = <%IdRazonSocial%>" & _
