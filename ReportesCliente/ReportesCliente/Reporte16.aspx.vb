...
Partial Public Class Reporte16

    Inherits System.Web.UI.Page

    Public RPT As New ISNAG
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomISNAG @IdRazonSocial = <%IdRazonSocial%>" & _
