...
Partial Public Class Reporte8
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_ReporteProvisionesCentroCostos @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNominaAsig=<" & _
