...
Partial Public Class Reporte15

    Inherits System.Web.UI.Page

    Public RPT As New ISNTI
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomISNTI @IdRazonSocial = <%IdRazonSocial%>" & _
