...
Public Class PercepcionesEmpleadosPorConceptoUnitario
    ...
    Private Sub PercepcionesEmpleadosPorConceptoUnitario_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_nomConceptoEmpleadoDetalleUnitario @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
