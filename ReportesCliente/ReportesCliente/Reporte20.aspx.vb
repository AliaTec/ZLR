...
Partial Public Class Reporte20

    Inherits System.Web.UI.Page

    Public RPT As New ISNMER
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomISNMER @IdRazonSocial = <%IdRazonSocial%>" & _
