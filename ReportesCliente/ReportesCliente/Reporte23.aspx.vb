...
Partial Public Class Reporte23

    Inherits System.Web.UI.Page

    Public RPT As New ISNMTY
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomISNMTY @IdRazonSocial = <%IdRazonSocial%>" & _
