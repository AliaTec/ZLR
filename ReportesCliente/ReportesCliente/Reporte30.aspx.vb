...
Partial Public Class Reporte30
    Inherits System.Web.UI.Page

    Public RPT As New CartaFiniquitook
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "sp_Reporte_CartaFiniquito @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNominaAsig=<" & _
