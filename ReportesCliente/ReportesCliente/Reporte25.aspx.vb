...
Partial Public Class Reporte25

    Inherits System.Web.UI.Page

    Public RPT As New AcumuladodeConceptos
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomAcumuladoConcepto @IdRazonSocial = <%IdRazonSocial%>" & _
               "@Anio = <%Anio%>,@UID = <%UID%>, @LID = <%LID%>, @idAccion = <%idAccion%>", 90)
        ...
        Try
            ...
            strName = "AcumuladodeConceptos" + Context.Session("UID").trim + Date.Now.Day.ToString + Date.Now.Month.ToString + Date.Now.Year.ToString + Date.Now.Minute.ToString + Date.Now.Second.ToString + ".xls"
